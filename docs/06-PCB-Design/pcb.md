...
## Resources
The PCBs project zip folder is a downloadable zip file [*here*](MichaelKim211.zip). The PCBs pdf file containing top and bottom layers can be found [*here*](PCBLayers2.pdf). Then the PCBs Gerber files can be found [*here*](GerberZIP.zip).
