...
## Resources
The PCBs project zip folder is a downloadable zip file [*here*](MichaelKim211.zip). The PCBs pdf file containing top and bottom layers can be found [*here*](PCBLayers.pdf).
